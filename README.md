...
Personal dotfiles for macOS and Linux, managed with chezmoi. On macOS, this will also install Homebrew, essential CLI packages including mise (runtime management) and starship (terminal prompt), and install GUI apps listed in the included Brewfile.
